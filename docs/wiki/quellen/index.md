...
Eine Notiz pro Quelle, in eigenen Worten. Aufbau jeder Notiz:
bibliografische Angaben, Evidenzstufe, Verifikationsvermerk, Kernaussagen,
Einordnung, Relevanz für diese Website, Querverweise.

Die Notizen entstehen sprintweise pro Thema, siehe
[Arbeitsweise](../index.md#arbeitsweise).

## Thema: KI-Nutzung deklarieren

**Policies (international):**

- [ICMJE: Use of AI by Authors](icmje-ki-nutzung-autoren.md)
- [COPE: Authorship and AI tools](cope-autorschaft-ki.md)
- [Elsevier: Generative AI policies for journals](elsevier-genai-policy.md)
- [Springer Nature / Nature Portfolio: AI-Policy](springer-nature-ki-policy.md)

**Policies (Schweiz):**

- [UZH: Empfehlungen zum Umgang mit generativer KI](uzh-empfehlungen-genki.md)
- [Scribbr: Richtlinien der 23 Schweizer Hochschulen](scribbr-2024-ch-hochschulen.md)
